  ...
  return (
    <>
      {/* <motion.button
        ...
        whileTap={{ scale: 0.95 }}
      >
        <span className={styles.buttonText}>Ask Amit</span>
          ...
          >
            <div className={styles.chatHeader}>
              <div className={styles.headerTitle}>
                ...
                <h3>Chat with Amit's AI Assistant</h3>
              </div>
              <button 
            ...
            <div className={styles.messageContainer} ref={messageContainerRef}>
              {messages.length === 0 && (
                <div className={styles.welcomeMessage}>
                  👋 Hi! I'm Amit's AI assistant. Ask me anything about his work, experience, or skills!
                </div>
              )}
