...
export default function Mentorship(): JSX.Element {
  return (
    <Layout>
      <SEO 
        title="Mentorship - Amit Sharma"
        description="Get personalized mentorship in full-stack development, React, Node.js, and cloud technologies from Amit Sharma. Book a session today."
        keywords={[
          "Amit Sharma mentor",
