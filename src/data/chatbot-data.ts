...
<ul>
  ...
  "education": {
    ...
    response: "I completed my Bachelor of Technology in Computer Science from JNTU Bangalore (2016-2020)."
  },
  "projects": {
...
<p><strong>Note:</strong> Referrals are based on merit and current openings. Let's discuss your profile in a 1:1 session first.</p>`
  ...
  "default": {
    keywords: [],
    response: `<p>👋 I'm Amit's AI assistant. I can tell you about his experience, projects, and mentorship services.</p>
